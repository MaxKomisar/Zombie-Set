        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (Global.GAMESTATE == GameState.EndGame)
            {
                if (Global.GAMEMODE == GameMode.EasyClassic)
                {
                    ...
                    spriteBatch.DrawString(m_gameFont, m_pointManager.m_totalPoint.ToString(), new Vector2(206, 250), Color.GreenYellow, 0.0f, Vector2.Zero, 0.8f, SpriteEffects.None, 0.9f);
                    spriteBatch.DrawString(m_gameFont, DataManager.GetInstance().EasyHighScore.ToString(), new Vector2(260, 337), Color.GreenYellow, 0.0f, Vector2.Zero, 0.8f, SpriteEffects.None, 0.9f);
                }
                if (Global.GAMEMODE == GameMode.NormalClassic)
                {
                    ...
                    spriteBatch.DrawString(m_gameFont, m_pointManager.m_totalPoint.ToString(), new Vector2(206, 250), Color.GreenYellow, 0.0f, Vector2.Zero, 0.8f, SpriteEffects.None, 0.9f);
                    spriteBatch.DrawString(m_gameFont, DataManager.GetInstance().NormalHighScore.ToString(), new Vector2(260, 360), Color.GreenYellow, 0.0f, Vector2.Zero, 0.8f, SpriteEffects.None, 0.9f);
                }
                if (Global.GAMEMODE == GameMode.Level)
                {
                    m_pLevelDone.Draw(spriteBatch);
                    spriteBatch.DrawString(m_gameFont, m_levelManager.m_currentLevel.ToString(), new Vector2(160, 135), Color.Yellow, 0.0f, Vector2.Zero, 1.0f, SpriteEffects.None, 0.9f);

                    spriteBatch.DrawString(m_gameFont, m_pointManager.m_totalPoint.ToString(), new Vector2(200, 240), Color.GreenYellow, 0.0f, Vector2.Zero, 0.8f, SpriteEffects.None, 0.9f);

                    int bonus = 100 * m_gameTimeManager.GetTimeBonus();
                    int total = bonus + m_pointManager.m_totalPoint;
                    
                    spriteBatch.DrawString(m_gameFont, bonus.ToString(), new Vector2(148, 327), Color.GreenYellow, 0.0f, Vector2.Zero, 0.8f, SpriteEffects.None, 0.9f);

                    spriteBatch.DrawString(m_gameFont, total.ToString(), new Vector2(128, 414), Color.GreenYellow, 0.0f, Vector2.Zero, 0.8f, SpriteEffects.None, 0.9f);
                }
            }
            if (Global.GAMESTATE == GameState.BeforeEndGame)
            {
