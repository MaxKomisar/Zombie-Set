        ...
        public void Draw(SpriteBatch spriteBatch,SpriteFont spriteFont)
        {
            ...
            if (Global.GAMESTATE != GameState.EndGame)
            {
                ...
                if (Global.GAMEMODE == GameMode.EasyClassic)
                {
                    ...
                    spriteBatch.DrawString(spriteFont, DataManager.GetInstance().EasyHighScore.ToString(), new Vector2(140,70), new Color(255, 253, 0), 0.0f, Vector2.Zero, 0.74f, SpriteEffects.None, 0.6f);
                    //chinese
                    //m_pHighScore.Draw(spriteBatch, new Vector2(50, 70));
                ...
                {
                    m_pHighScore.Draw(spriteBatch, new Vector2(50, 70));
                    spriteBatch.DrawString(spriteFont, DataManager.GetInstance().NormalHighScore.ToString(), new Vector2(140, 70), new Color(255, 253, 0), 0.0f, Vector2.Zero, 0.74f, SpriteEffects.None, 0.6f);
                    //chinese
                    //m_pHighScore.Draw(spriteBatch, new Vector2(50, 70));
