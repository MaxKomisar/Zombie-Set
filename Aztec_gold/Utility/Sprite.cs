...
namespace Aztec_gold
{
    class Sprite
    {
        ...
        public void setFrame(int _curFrame)
        {
        ...
        public void Draw(SpriteBatch theSpriteBatch, Rectangle _srcRect, Rectangle _srcDes)
        {
            theSpriteBatch.Draw(m_texture, _srcDes, _srcRect, Color.White, m_rotation, m_origin, SpriteEffects.None, m_depth);
        }
    }
}
